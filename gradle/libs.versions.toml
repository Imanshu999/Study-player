...
googleDevtoolsKsp = "2.1.10-1.0.29"
...
media3-exoplayer = { group = "androidx.media3", name = "media3-exoplayer", version = "1.5.0" }
media3-ui = { group = "androidx.media3", name = "media3-ui", version = "1.5.0" }
